...
// const dynamicSubCategories = computed(() => { // if (!selectedCategory.value)
return []; // const subCategoriesSet = new Set(); //
articles.value.forEach(article => { // if
(article.tags.includes(selectedCategory.value) && article.subCategory) { //
subCategoriesSet.add(article.subCategory); // } // }); // return
[...subCategoriesSet]; // });
